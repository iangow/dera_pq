...
Downloads one SEC DERA Financial Statement and Notes zip file and writes
its component Parquet files under `$DATA_DIR/dera_notes`.

## Usage

``` r
update_dera_notes_file(file, data_dir = NULL, user_agent = NULL, quiet = FALSE)
```
